...
qqline(beymod3$residuals) #this looks pretty normal!! great
#testing assumptions
# we fail to reject normality or homoscedasticity of any main factors
shapiro.test(beymod3$residuals) #hip hip hooray it is normal!
bartlett.test(beymod3$residuals~A) #homoscedastic
bartlett.test(beymod3$residuals~B) #homoscedastic
bartlett.test(beymod3$residuals~C) #homoscedastic
bartlett.test(beymod3$residuals~D) #homoscedastic
```
